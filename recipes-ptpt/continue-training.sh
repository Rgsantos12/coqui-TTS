...
# This script is used to continue training in a distributed manner.
...
CUDA_VISIBLE_DEVICES="<gpus>" python -m trainer.distribute --script train_tts.py --continue_path "<output_path>" 