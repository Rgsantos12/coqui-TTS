...
# This script is used to train HiFi-GAN in a distributed manner.
# Replace <gpus> with the appropriate GPU device IDs for your setup.
# Use the command, to find the number of the available gpus: 
...
CUDA_VISIBLE_DEVICES="<gpus>" python -m trainer.distribute --script hifigan/train_hifigan.py
